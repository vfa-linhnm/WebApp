...
const App = () => {
  const setNoti = () => {
    PushNotification.localNotification({
      ...
      channelId: 'linh', // (required) channelId, if the channel doesn't exist, notification will not trigger.
  ...
  function setNotiSchedule() {
    console.log('run schedule');

    PushNotification.localNotificationSchedule({
      //... You can use all the options from localNotifications
      channelId: 'channel-id',
      message: `${new Date().getMinutes()}`, // (required)
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Button title="active" onPress={setNotiSchedule} />
      <Button
        title="cancel"
